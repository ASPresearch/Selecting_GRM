...
#creating 100 L shaped variables with 50 data points
=======
#creating 100 L shaped variables with 1000 data points
>>>>>>> 5f6968e332b1977addf3ede9d987bedb62da669f
...
=======
#creating 250 non L shaped variables with 1000 data points - top horizontal distribution
>>>>>>> 5f6968e332b1977addf3ede9d987bedb62da669f
...
=======
#creating 250 non L shaped variables with 1000 data points - bottom horizontal distribution
>>>>>>> 5f6968e332b1977addf3ede9d987bedb62da669f
...
=======
#creating 500 non L shaped variables with 1000 data points - random distribution
>>>>>>> 5f6968e332b1977addf3ede9d987bedb62da669f
...
=======
#creating 250 non L shaped variables with 1000 data points - vertical distribution left
>>>>>>> 5f6968e332b1977addf3ede9d987bedb62da669f
...
=======
#creating 250 non L shaped variables with 1000 data points - vertical distribution right
>>>>>>> 5f6968e332b1977addf3ede9d987bedb62da669f
...
colnames(expr10x) <- paste0("s", 1:1000)
colnames(expr10x)[1001] <- "Class"
colnames(met10x) <- colnames(expr10x)


# write.csv(met10x, "methylation10_simulTuning1000.csv")
# write.csv(expr10x, "expression10_simulTuning1000.csv")
```
...
colnames(expr1x) <- paste0("s", 1:1000)
colnames(expr1x)[1001] <- "Class"
colnames(met1x) <- colnames(expr1x)


# write.csv(met1x, "methylation1_simulTuning1000.csv")
write.csv(expr1x, "expression1_simulTuning1000.csv")
```
