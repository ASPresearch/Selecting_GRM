...
\end{verbatim}
\begin{alltt}
\hlstd{trueLExpr} \hlkwb{<-} \hlstd{DAExprData[}\hlkwd{rownames}\hlstd{(DAExprData)} \hlopt{%in%} \hlstd{trueLGeneNames ,]}
\hlstd{falseLExpr} \hlkwb{<-} \hlstd{DAExprData[}\hlkwd{rownames}\hlstd{(DAExprData)} \hlopt{%in%} \hlstd{falseLGeneNames ,]}
\hlstd{trueLMet} \hlkwb{<-} \hlstd{DAMetilData[}\hlkwd{rownames}\hlstd{(DAMetilData)} \hlopt{%in%} \hlstd{trueLGeneNames ,]}
\hlstd{falseLMet} \hlkwb{<-} \hlstd{DAMetilData[}\hlkwd{rownames}\hlstd{(DAMetilData)} \hlopt{%in%} \hlstd{falseLGeneNames ,]}
...
\end{verbatim}
\begin{alltt}
\hlstd{GEOtrueLExpr} \hlkwb{<-} \hlstd{geoExprData[}\hlkwd{rownames}\hlstd{(geoExprData)} \hlopt{%in%} \hlstd{GEOtrueLGeneNames ,]}
\hlstd{GEOfalseLExpr} \hlkwb{<-} \hlstd{geoExprData[}\hlkwd{rownames}\hlstd{(geoExprData)} \hlopt{%in%} \hlstd{GEOfalseLGeneNames ,]}
\hlstd{GEOtrueLMet} \hlkwb{<-} \hlstd{geoMetilData[}\hlkwd{rownames}\hlstd{(geoMetilData)} \hlopt{%in%} \hlstd{GEOtrueLGeneNames ,]}
\hlstd{GEOfalseLMet} \hlkwb{<-} \hlstd{geoMetilData[}\hlkwd{rownames}\hlstd{(geoMetilData)} \hlopt{%in%} \hlstd{GEOfalseLGeneNames ,]}
\hlstd{GEOTrueFalseExpr} \hlkwb{<-} \hlstd{geoExprData[}\hlkwd{rownames}\hlstd{(geoExprData)} \hlopt{%in%} \hlkwd{c}\hlstd{(GEOtrueLGeneNames,GEOfalseLGeneNames) ,]}
\hlstd{GEOTrueFalseMet} \hlkwb{<-} \hlstd{geoMetilData[}\hlkwd{rownames}\hlstd{(geoMetilData)} \hlopt{%in%} \hlkwd{c}\hlstd{(GEOtrueLGeneNames,GEOfalseLGeneNames) ,]}
